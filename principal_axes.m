...
% thetap is the counterclockwise angle (RADIANS) the major axes makes with the 
%        original x-axis.
%
% To get back to units of the time series: sqrt(l1) and sqrt(l2)
%
% July 12, 2002
%
...
%   meanv = mean(vp);
%   
%   Remove means. Principal axes is calculated from the velocity
%   fluctuation (Emory and Thompson)
